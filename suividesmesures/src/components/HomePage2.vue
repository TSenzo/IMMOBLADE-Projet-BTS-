            ...
            <div>
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    <td>Témoin</td>
                    <td :style="{ backgroundColor: rssiTemoin !== null && rssiTemoin < -80 ? 'red' : 'white' }">{{ rssiTemoin }}</td>
                    <td :style="{ backgroundColor: batterieTemoin !== null && batterieTemoin < 20 ? 'red' : 'white' }">{{ batterieTemoin }}</td>
                  </tr>
                  <tr>
                    <td>Équipée</td>
                    <td :style="{ backgroundColor: rssiEquipe !== null && rssiEquipe < -80 ? 'red' : 'white' }">{{ rssiEquipe }}</td>
  ...
  export default {
    ...
    methods: {
      ...
      addEvent (event) {
        ...
        if (event.type === 84) {
          if (event.idCapteur === 'temoin') {
            this.temperatureTemoin = event.payload
          } else if (event.idCapteur === 'equipe') {
